...
dotfilesrepo="https://github.com/PrWalterB/occitan-voidrice.git"
...
welcomemsg() {
	whiptail --title "La Benvenguda!" \
		--msgbox "La Benvenguda dins le Luke's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
